 ...
 */
class AllPokemonFragment : Fragment(R.layout.fragment_pokemon_list) {
    ...
    inner class Adapter : RealmRecyclerViewAdapter<Pokemon, PokemonViewHolder>(
        ...
        override fun onBindViewHolder(holder: PokemonViewHolder, position: Int) {
            ...
            holder.bind(pokemon) { model.select(pokemon) }
        }
    }
